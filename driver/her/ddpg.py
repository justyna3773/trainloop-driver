...
from driver.her.util import (
    import_function, store_args, flatten_grads, transitions_in_episode_batch, convert_episode_to_batch_major)
from driver.her.normalizer import Normalizer
from driver.her.replay_buffer import ReplayBuffer
...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        Args:
            ...
            network_class (str): the network class that should be used (e.g. 'driver.her.ActorCritic')
