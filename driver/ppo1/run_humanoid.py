#!/usr/bin/env python3
import os
from driver.common.cmd_util import make_mujoco_env, mujoco_arg_parser
from driver.common import tf_util as U
...
def train(num_timesteps, seed, model_path=None):
    env_id = 'Humanoid-v2'
    from driver.ppo1 import mlp_policy, pposgd_simple
