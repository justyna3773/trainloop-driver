...
from driver.common.policies import build_policy
from driver.common.tf_util import get_session, save_variables, load_variables
from driver.common.vec_env.vec_frame_stack import VecFrameStack

from driver.a2c.utils import batch_to_seq, seq_to_batch
from driver.a2c.utils import cat_entropy_softmax
from driver.a2c.utils import Scheduler, find_trainable_variables
from driver.a2c.utils import EpisodeStats
from driver.a2c.utils import get_by_index, check_shape, avg_norm, gradient_add, q_explained_variance
from driver.acer.buffer import Buffer
from driver.acer.runner import Runner
...
def learn(network, env, seed=None, nsteps=20, total_timesteps=int(80e6), q_coef=0.5, ent_coef=0.01,
    ...
    network:            policy network architecture. Either string (mlp, lstm, lnlstm, cnn_lstm, cnn, cnn_small, conv_only - see driver.common/models.py for full list)
                        specifying the standard network architecture, or a function that takes tensorflow tensor as input and returns
                        tuple (output_tensor, extra_feed) where output tensor is the last network layer output, extra_feed is None for feed-forward
                        neural nets, and extra_feed is a dictionary describing how to feed state into the network for recurrent neural nets.
                        See driver.common/policies.py/lstm for more details on using recurrent nets in policies

    env:                environment. Needs to be vectorized for parallel environment simulation.
                        The environments produced by gym.make can be wrapped using driver.common.vec_env.DummyVecEnv class.
    ...
    **network_kwargs:               keyword arguments to the policy / network builder. See driver.common/policies.py/build_policy and arguments to a particular type of network
