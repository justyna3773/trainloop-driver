...
def common_arg_parser():
    ...
    parser.add_argument('--num_timesteps', type=float, default=1000),
    ...
    parser.add_argument('--simulator_speedup', type=float, default=1000.0)
    parser.add_argument('--test', default=False, action='store_true')
    parser.add_argument('--workload_file', default='SYNTHETIC-DNNEVO.swf', type=str)
    parser.add_argument('--mips_per_core', default=2, type=int)
    ...
    parser.add_argument('--queue_wait_penalty', type=float, default=0.1)
